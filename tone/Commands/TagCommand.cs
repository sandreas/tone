...
public class TagCommand : ICommand, IMetadata
{
    ...
    public bool IsItunesCompilation { get; set; }

    public ItunesCompilation? ItunesCompilation
    {
        get => IsItunesCompilation ? Metadata.ItunesCompilation.Yes : null;
        set => IsItunesCompilation = value == Metadata.ItunesCompilation.Yes;
    }
    ...
    public bool HasItunesPlayGap { get; set; }

    public ItunesPlayGap? ItunesPlayGap
    {
        get => HasItunesPlayGap ? Metadata.ItunesPlayGap.InsertGap : null;
        set => HasItunesPlayGap = value == Metadata.ItunesPlayGap.InsertGap;
    }

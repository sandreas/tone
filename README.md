...
```bash
wget https://github.com/sandreas/m4b-tool/releases/latest/download/tone.tar.gz
wget https://github.com/sandreas/m4b-tool/releases/latest/download/tone.zip

https://github.com/sandreas/tone/releases/download/v0.0.1/tone-0.0.1-linux-arm.tar.gz
